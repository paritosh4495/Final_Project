...
# img bg
        ...
        title_lbl = Label(bg_img, text="Student Management System.",font=("helvetica", 15,"bold"),bg="white",fg="darkgreen")
        title_lbl.place(x=0,y=0,width=1530,height=30)


        main_frame=Frame(bg_img,bd=2,bg="white")
        main_frame.place(x=7,y=40,width=1500,height=600)
        # #left label frame
        Left_frame=LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="Student Details",font=("time new roman",12,"bold"))
        Left_frame.place(x=5,y=0,width=720,height=580)
        ...
        save_btn=Button(btn_frame,command=self.add_data,text="Save",width=17,font=("times new roman",13,"bold"),bg="Beige",fg="black")
        save_btn.grid(row=0,column=0)

        update_btn=Button(btn_frame,command=self.update_data,text="Update",width=17,font=("times new roman",13,"bold"),bg="Beige",fg="black")
        update_btn.grid(row=0,column=1)

        delete_btn=Button(btn_frame,command=self.delete_data,text="Delete",width=17,font=("times new roman",13,"bold"),bg="Beige",fg="black")
        delete_btn.grid(row=0,column=2)

        reset_btn=Button(btn_frame,command=self.reset_data,text="Reset",width=17,font=("times new roman",13,"bold"),bg="Beige",fg="black")
        ...
        take_photo_btn=Button(btn_frame1,command=self.generate_dataset,text="Take a photo Sample",width=34,font=("times new roman",13,"bold"),bg="Beige",fg="black")
        take_photo_btn.grid(row=0,column=0)

        update_btn=Button(btn_frame1,text="Update photo",width=35,font=("times new roman",13,"bold"),bg="Beige",fg="black")
        update_btn.grid(row=0,column=1)
        ...
        Right_frame.place(x=750,y=5,width=740,height=580)

        img_right=Image.open(r"Images\right.jpg")
        ...
        search_label=Label(search_frame,text="Search By:",font=("time new roman",15,"bold"),bg="Beige",fg="black")
        ...
        search_btn=Button(search_frame,text="Search",width=12,font=("times new roman",12,"bold"),bg="Beige",fg="black")
        search_btn.grid(row=0,column=3,padx=10,pady=5,sticky=W)

        showall_btn=Button(search_frame,text="Show All",width=12,font=("times new roman",12,"bold"),bg="Beige",fg="black")
        showall_btn.grid(row=0,column=4,padx=2)
     

        # #table frame
        table_frame=Frame(Right_frame,bd=2,bg="white",relief=RIDGE)
        table_frame.place(x=5,y=210,width=700,height=300)
